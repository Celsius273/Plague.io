...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsComponentsTestComponent = __webpack_require__(1);

	var _jsComponentsTestComponent2 = _interopRequireDefault(_jsComponentsTestComponent);
	...
	ReactDOM.render(React.createElement(_jsComponentsTestComponent2['default'], null), document.getElementById('container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TestComponentChild = _react2['default'].createClass({
	    ...
	    propTypes: {
	        TestStore: _react2['default'].PropTypes.object.isRequired
	    },

	    submit: function submit(input) {
	        _actionsTestActions2['default'].testAction(input.test);
	    },

	    render: function render() {
	        var message = this.props.TestStore.get('message');
	        var inputName = 'test';
	...
	var TestComponent = _react2['default'].createClass({
	    ...
	    render: function render() {
	        var stores = {
	            TestStore: _storesTestStore2['default']
	        };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _altUtilsDecorators = __webpack_require__(195);
	...
	var TestStore = (function () {
	    ...
	    function TestStore() {
	        _classCallCheck(this, _TestStore);

	        this.state = this.defaultState();
	    }

	    _createDecoratedClass(TestStore, [{
	        key: 'defaultState',
	    ...
	    var _TestStore = TestStore;
	    TestStore = (0, _altUtilsDecorators.decorate)(_alt2['default'])(TestStore) || TestStore;
	    return TestStore;
	})();
